...
- Put TLS termination and access controls in front of the public shared MQTT WebSocket and dashboard/API listener where appropriate. The Node.js listener is plain HTTP/WebSocket. The dashboard, JSON APIs, OpenAPI document, and Swagger UI have no built-in authentication, and MQTT subscriber roles do not apply to them.
