...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    /* Dashboard UI refresh: clearer hierarchy, denser mobile layouts and
       consistent interaction states. Kept in one final layer so responsive
       rules remain easy to audit against the rendered screenshots. */
    :root {
      --green-950: #043d2f;
      --surface-soft: #f5f9f7;
      --surface-tint: #edf8f3;
      --line-strong: #cddbd3;
      --shadow-sm: 0 1px 2px rgba(15, 23, 42, .04), 0 8px 24px rgba(15, 23, 42, .045);
      --shadow-lg: 0 30px 90px rgba(15, 23, 42, .24);
    }
    body {
      line-height: 1.45;
    ...
    [role="button"]:focus-visible {
      outline: 3px solid rgba(12, 143, 103, .28);
      outline-offset: 2px;
    }
    .shell {
    ...
    @media (max-width: 800px) {
      ...
      td:nth-child(even):not(.primary-cell):not(.wide-cell) {
      ...
      .publish-region .region-name {
        font-size: 11px;
      }
      .publish-region .region-code {
        font-size: 9px;
      }
      .panel-actions,
      .feed-actions {
      ...
      .modal-header {
        ...
        box-shadow: 0 1px 0 #e7eeea, 0 5px 16px rgba(15, 23, 42, .05);
      }
      .modal-header h2 {
        margin-bottom: 3px;
        font-size: 19px;
      ...
      .modal-body {
        padding: 13px 12px calc(24px + env(safe-area-inset-bottom));
        gap: 16px;
      }
      .modal-body > section {
        gap: 9px;
    ...
    /* Material Design 3 system layer.
       Containers are reserved for page-level surfaces. Statuses and metadata
       use text, icons, and dividers instead of decorative chips or nested cards. */
    :root {
      --md-sys-color-primary: #006c4c;
      --md-sys-color-on-primary: #ffffff;
      --md-sys-color-primary-container: #89f8c4;
      --md-sys-color-on-primary-container: #002116;
      --md-sys-color-secondary-container: #d1e8da;
      --md-sys-color-on-secondary-container: #0b1f17;
      ...
      --md-sys-elevation-1: 0 1px 2px rgba(0, 0, 0, .18), 0 1px 3px 1px rgba(0, 0, 0, .08);
      --md-sys-elevation-3: 0 4px 8px 3px rgba(0, 0, 0, .10), 0 1px 3px rgba(0, 0, 0, .16);
      --green-900: #004d35;
      --green-800: var(--md-sys-color-primary);
      --green-700: #087a58;
      --green-100: var(--md-sys-color-primary-container);
      --green-50: #e8f7ef;
    ...
    .overview-lookup .panel-subtitle {
      max-width: 760px;
    }
    .lookup-form {
      max-width: 920px;
    ...
    .broker-reference:not(:last-child)::after {
      content: ", ";
    }
