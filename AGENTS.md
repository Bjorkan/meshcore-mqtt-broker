...
5. Existing Swedish runtime/operator text outside neutral configuration errors and region corrections, `allowed_regions`, read-only YAML configuration, “Nekad”/“Varnas” wording, integrated target forwarding, and MeshCore.io opt-in remain fork features.
