...
Direct runtime dependencies declare permissive licenses: MIT, ISC, or BSD-3-Clause. `package-lock.json` fixes the complete transitive dependency set. Review installed package license files when preparing binary distributions or changing dependencies.
