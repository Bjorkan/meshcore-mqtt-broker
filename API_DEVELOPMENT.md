...
`createOpenApiDocument()` reads `PublicToolRegistry.descriptions()` and converts every registered Zod schema to OpenAPI-compatible JSON Schema. Swagger therefore shows 23 distinct paths such as:
